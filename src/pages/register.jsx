...
<input className='w-[100%] border-solid border-[1px] border-[gray] rounded-[5px] py-[0.5rem] placeholder:text-center px-[1rem]' placeholder='Insert url' type="text" />
</div>
<div className='w-[70%] flex flex-col h-[4rem] justify-center '>
<p  className='text-[#F97316] bg-[white] mb-[2.5rem] absolute ml-[0.8rem]'>Email</p>
<input className='w-[100%] border-solid border-[1px] border-[gray] rounded-[5px] py-[0.5rem] placeholder:text-center px-[1rem]' placeholder='Insert your email' type="text" />
</div>
<div className='w-[70%] flex flex-col  h-[4rem] justify-center '>
<p className='text-[#F97316] bg-[white] mb-[2.5rem] absolute ml-[0.8rem]'>Password</p>
<input className='w-[100%] border-solid border-[1px] border-[gray] rounded-[5px] py-[0.5rem] placeholder:text-center px-[1rem]' placeholder='Insert your password' type="password" />
</div>
...
<button className='bg-[#F97316] p-[0.5rem] w-full rounded-[5px] text-[white]'>Sign up</button>
